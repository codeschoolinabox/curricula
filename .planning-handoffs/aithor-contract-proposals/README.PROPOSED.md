...
> relative to THIS dossier directory so they resolve while reviewing — whoever
> lands this file re-bases every relative href for the landing seat (Wave 2: the
> current seat; Wave 3 re-homes them again).
