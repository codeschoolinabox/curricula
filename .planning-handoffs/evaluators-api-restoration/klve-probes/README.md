...
| `probe-klve-r2.mjs`  | 2     | `N*` — getter overflow (klve-084, r8 vi), BigInt (klve-086), null-proto (klve-087), post-await (klve-085, r9), undefined-value key (klve-030), logs-key shape (klve-090), module syntax (klve-089, r8 ix), receiver control                                                                                       |
| `probe-klve-r2b.mjs` | 2     | the getter-overflow minimal pair (klve-084)                                                                                                                                                                                                                                                                       |
