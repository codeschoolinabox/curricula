...
| --- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A1  | Three classes, exhaustive over the surfaces the mask ACTS ON; the overlay is apparatus and takes no class        | `README.md` § Enforcement                           | `README.md` glossary · surface classes; `lib/masking/README.md` § The three surface classes; `lib/masking/types.ts` `SurfaceClass`; `ux/wireframes.md` § The parts, § Strict, covering — editor mode; **`editor/README.md`**; `index.tsx`; **`editor/DOCS.md`** — "surface class 1 while mounted"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | **`open (round 8 M9)`** — the census's two sites are RECEIPTED here: `editor/README.md` "The editor is surface class 1" and `index.tsx` "the class-1 editor renders in its own slot OUTSIDE both maskable containers", both agreeing with § Enforcement, so amendment 4's re-open is discharged. `editor/DOCS.md` joins them. **M9 stays open**: `lib/masking/README.md` still opens class 3 as "everything else", the wording BLOCKER 1 retired at three sites surviving at the fourth. One qualified receipt — `editor/README.md` grounds class 1 on "because editing is how conformance is restored", which is not false but is the vocabulary R-E narrowed; noted rather than swept (round 8 I5) |
...
| C12 | **The slot beneath the rail** — its total precedence rule (cause line › count line › nothing), and whether the object has a name at all | `README.md` glossary · display labels               | **`DOCS.md` § The render projection now carries all four rules and the total precedence** (added 2026-08-18, human approval — `DOCS.md` is an architectural contract); `README.md` glossary · display labels (the home); `ux/wireframes.md` § Fresh mount, § The parse breaks, § The spelling breaks (drawn)                                                                                  | **SETTLED IN FULL** — I7's half at `b086afe6`; **M12's half here: the object is named `the caption`** (human ruling 2026-08-18). The hold was wrong for the reason it was held — shaping 0.3's types is what 0.2 is for, and `station`, `standing`, `pane occupant` and `assessment` were all named at 0.2 on that argument | reason line`over`DOCS.md`→ **0**];`ux/wireframes.md`§ Fresh mount, § The parse breaks (drawn);`README.md` and the twin both refer to it by the phrase, never by a name | **open (round 8 I7 + M12)** — the sketch AR-2 is held against does not carry the contract |
