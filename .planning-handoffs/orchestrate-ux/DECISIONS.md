...
| **F3**  | `phases-panel/` exists on disk, is absent from the manifest, and is navigated to as a live peer by **eight** documents including `DEV.md` [measured 2026-08-18; this line and F3's row both said six].                                                                                                                                                       |
