...
| F4  | **Module homes for the copy** — the display-labels entry enumerates the keyed-or-derived families; the manifest names **one** file | `README.md` § What lives here | `README.md` glossary · display labels; `display-labels.ts`, which holds one string per phase and has a live consumer [read: `display-labels.ts`; measured: `index.tsx:654`]; rows C1, C2, C3, C5, C9, C11, C12, C13                                                                                                                                                                                                                          | **open (round 8 I8 / CP-E)**                                                                                                                                                                                                  |
