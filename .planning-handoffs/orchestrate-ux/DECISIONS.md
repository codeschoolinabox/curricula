...
| D6  | The **tray entry for the open lens is its own close affordance**, replacing the strip's none entry | `ux/wireframes.md` § An excursion open | `README.md` glossary · dispose; `DOCS.md` § Execution phases 4, § The render projection; `event-bus/README.md` (the `lens-opened` row); **`editor/README.md`** — "The strip's none entry closes an open lens too", the site the census found and no row carried | **0.3** (I6) — status unchanged; the column gains `editor/README.md`, which amendment 4 does not re-open because this row was never closed                                                                                                                                                                                                                                                                                                         |
...
| --------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **I6** · dispose enumeration                        | D6                    | `README.md` glossary · dispose, `DOCS.md`, `event-bus/README.md` and `editor/README.md` enumerate **the strip's none entry** as a live dispose raiser. The Rail abolishes it and the open lens's **tray entry** takes its place. **The recorded reason for deferring — that it needs `Station`'s shape — is DISPROVEN, not merely superseded** (R-N, CP-A): the twin already names the replacement, the tray is settled (B5, B6, glossary · tray), and a station with a tray is openable by construction, so the entry exists under either answer to B10. **This discharges NOW.** |
...
| **The `strip` VOCABULARY migration**                | D6, D8                | Distinct from I6, and this half genuinely waits. `strip` survives across `README.md`, `DOCS.md`, `ux/wireframes.md`, `event-bus/README.md`, `editor/README.md`, `generator/README.md` and all of `phases-panel/**`. Counts omitted deliberately — they have gone stale twice in this file. Some uses are **sanctioned lineage** ("Supersedes the lifecycle strip") and must keep the retired word to stay legible.                                                                                                                                                                 |
