...
Printing a string to the console is the minimum viable program for illustrating the rhetorical relationship between developers, source code, and a computer. The developer writes instructions (source code), the computer executes them (dynamic execution), and the output appears in the console (for the developer to observe). See the diagrams in `../0-what-is-programming/assets/rhetorics-of-programming/` — particularly [`a-program.png`](../0-what-is-programming/assets/rhetorics-of-programming/a-program.png) which shows this exact relationship.
