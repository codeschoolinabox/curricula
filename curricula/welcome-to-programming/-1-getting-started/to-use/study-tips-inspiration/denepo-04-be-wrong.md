...
You will be wrong every day you write code. There are many great reasons for this:
...
* __You are working collaboratively.__ You may know what _should_ be happening, but that's no guarantee it _does_ work that way!
* __Every language feature, tool, and library you use was designed by another human.__ There is often no way to guess how something works, you need to read their documentation.
* __You are never doing the same task twice.__ Every time you sit down to write some code, you are approaching a brand new problem with tools that are always changing.
