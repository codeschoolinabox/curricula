 ...
 */
function resolveGenerator(path: string): ((...args: readonly unknown[]) => unknown) | undefined {
...
function createTraceEvent(
	...
	if (!generator) {
		throw new Error(`createTraceEvent: no generator found at path '${generatorPath}'`);
	}
