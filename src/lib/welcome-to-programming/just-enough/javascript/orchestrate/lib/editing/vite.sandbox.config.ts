 ...
 *
 * Usage: npx vite --config src/lib/welcome-to-programming/just-enough/javascript/orchestrate/lib/editing/vite.sandbox.config.ts
 */
...
export default defineConfig({
	root: 'src/lib/welcome-to-programming/just-enough/javascript/orchestrate/lib/editing',
	resolve: {
		alias: {
