...
// TraceOutcome and TraceResult migrated to
// lib/evaluating/trace/semantics/types.ts (engine-owned, per the
// pattern in evaluating/{run,intercept}/types.ts).
...
// TraceResult / TraceOutcome → lib/evaluating/trace/semantics/types.ts
// ASTNode → lib/evaluating/trace/semantics/tracing/types.ts
// TraceOptions → lib/evaluating/trace/semantics/config.types.ts
