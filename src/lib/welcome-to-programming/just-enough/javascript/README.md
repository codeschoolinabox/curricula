...
JavaScript", see [the reference](./reference.md)) and executes it in sandboxed
environments. Provides validation, formatting, and three execution modes (run,
trace, debug) — all through a unified API with a code object factory as the
default export.
