...
| ------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `analysis/`                                                   | Snippet analysis report producer. Consumes `embodiment`; produces `AnalysisReport` (the canonical input the recommender ranks against). Does NOT exist pre-refactor; landed by WS2. | (none — new module)                                              | [`02-analysis-and-recommender.md`](../../.planning-handoffs/02-analysis-and-recommender.md) (WS2 owns) |
| `recommender/`                                                | Applicability filter + Ranking engine. Consumes `embodiment` + `AnalysisReport`; produces ranked `Recommendation` arrays. | [`../../lib/recommender/`](../../lib/recommender/)               | [`02-analysis-and-recommender.md`](../../.planning-handoffs/02-analysis-and-recommender.md) (WS2 owns) |
