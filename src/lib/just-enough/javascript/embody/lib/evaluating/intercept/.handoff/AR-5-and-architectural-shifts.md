...
Trace module (referenced in Job 3 — read these to understand the convention being borrowed): `src/lib/just-enough/javascript/lib/evaluating/trace/syntax/` and `src/lib/just-enough/javascript/lib/evaluating/trace/semantics/`.
