// ported from src/lib/study-lenses--deprecated-architecture/lib/quizzing/tests/v6b-const-update.test.ts
// @ blob 800bdbd21eae07bf95250358d82f1992761192a8
...
describe('v6bConstUpdate', () => {
	...
	describe('Interfaces', () => {
		it('emits only mcq items', () => {
			const facts = embody('const x = 1;').facts;
			const items = runGenerators(buildContext(facts, classifyOf(facts)), [
				v6bConstUpdate,
			]);
