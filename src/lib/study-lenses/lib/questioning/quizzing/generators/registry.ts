 ...
 * sameness forms (binding, binding × use-type, and cross-variable use-type),
 * and the program-anchored V4 (two-chains — scope vs prototype resolution —
 * which reads both context anchor streams at once, so it fires last).
 */
