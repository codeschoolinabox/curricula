...
const GUIDE_TOPICS: ReadonlyArray<GuideTopic> = freezeInPlace([
	...
	},
	{
		...
		body: 'Out of the box you are only ever notified — the selected level’s mark updates as you type, and nothing is taken away. Turning on strict makes the selected level binding: the study surfaces pause while your code steps outside it — and the way back to your code, plus every restoring control, keeps working the whole time.',
	},
	{
		key: 'snippet-type',
