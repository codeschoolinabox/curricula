...
By the end of this subchapter, learners will have seen all the data types and operators they'll need for the entire curriculum. This is a breadth chapter — surveying the type system rather than going deep on any single type.
...
- 🥚 Type coercion rules (different in JS vs. Python — this is explicitly discussed)
- 🐣 How operators work across types
- 🐣 Short-circuiting in boolean operators (demonstrated with logs — `true || console.log('skipped')`)
