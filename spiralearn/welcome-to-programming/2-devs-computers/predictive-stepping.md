...
> - [A class recording](https://www.youtube.com/watch?v=GAjQbsqTt4A) covering
>   [these examples](https://github.com/denepo/predictive-stepping).
...
To check if you _really_ understand a program, practice stepping through it in
the debugger like so:

0. Don't step forward yet!
1. Predict what will change program state, and which line will be next
