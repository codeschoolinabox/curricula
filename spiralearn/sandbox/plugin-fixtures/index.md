...
- [frontmatter-default-lens](./frontmatter-default-lens/) — frontmatter `defaultLens` precedence
...
> The `readme-with-index` fixture (coexisting `README.md` + `index.md`)
> stays under `src/plugins/study-lenses/tests/fixtures/` — Docusaurus's
> routing can error on dual-index pages. Its behavior is covered by
> unit tests only.
