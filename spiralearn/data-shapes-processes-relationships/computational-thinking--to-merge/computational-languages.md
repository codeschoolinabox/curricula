...
without it the directory counts its own prose, and that number climbs every time
one of these documents uses the phrase — so it is not published here. See
[tie-ins.md](./tie-ins.md) § "Two hazards".
