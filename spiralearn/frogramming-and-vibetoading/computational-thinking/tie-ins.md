...
| `ontology.md:936-946`                     | Ch2's data-flow loop already models the user as a data-transforming system — data in through the eyes, transformed, back through a resolve event                                                                    | Name it as modelling computation with a human target — and, once the program is in a real user's hands, as meaningful computation. It is the counterexample to any ruling that V's practice is not CT |
...
| `ontology.md` §9 scope column                                                                                                                                      | Lens deferral currently reads as editorial scope-discipline                                                                               | Gains the legibility criterion as its reason, which makes lens 3 contingently rather than permanently deferred                                                                                                                                                            |
